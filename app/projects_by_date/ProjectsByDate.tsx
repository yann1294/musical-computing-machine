    ...
    >
      ...
      <div className=" row-start-2 row-span-4 col-start-2 col-span-10 ">
        <div className="flex justify-evenly py-14 mt-2 ">
          <div
            className="max-w-sm m-2 pb-4 rounded-tl-full rounded-tr-full rounded-bl-full rounded-br-full shadow-lg bg-[#B9DEC3] "
            ...
            <Link href="/projet1">
              ...
              <figcaption>
                <div className=" mt-3 ml-2 text-center">
                  <p className="text-base text-gray-700 ">Début : 2016</p>
          ...
          >
            <Link href="/projet4">
              ...
              <figcaption>
                <div className=" mt-3 ml-2 text-center">
                  <p className="text-base text-gray-700 ">Début : 2018</p>
                  <p className="text-base text-gray-700 ">
                    Lieu : Nganda, Congo
                  </p>
                </div>
      ...
      <div className="row-start-6 col-start-6">
        <div className="join ">
          ...
          <button className="bg-[rgba(248,184,100,0.8)] hover:bg-amber-500 join-item btn ">
            2
          </button>
          <button className="bg-[rgba(248,184,100,0.8)] hover:bg-amber-500 join-item btn">
            3
