...
const PalmierLandingPage3 = () => {
    ...
    <div className="bg-cover bg-center w-full" style={{ backgroundImage: "url('/bgPalmierLanding3.png')", backgroundSize: "100% 100%" }}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-14 mt-2">
            <div className="max-w-sm mx-auto overflow-visible rounded-full shadow-lg bg-[#B9DEC3] hover:bg-[#EDEDCB]">
                <Link href="projet4">
                    <figure className="transition-all duration-300 cursor-pointer filter grayscale hover:grayscale-0">
                        ...
                        <div className="absolute bg-amber-500 text-white font-medium text-[17px] px-[10px] ml-4 mt-4 pt-[5px] flex items-center">Réfection école</div>
                    </figure>    
                    <figcaption>
            ...
            <div className="max-w-sm mx-auto overflow-visible rounded-full shadow-lg bg-[#B9DEC3] hover:bg-[#EDEDCB]">
                <Link href="projet2">
                    <figure className="transition-all duration-300 cursor-pointer filter grayscale hover:grayscale-0">
                        ...
                        <div className="absolute bg-amber-500 text-white font-medium text-[17px] px-[10px] ml-8 mr-2 mt-4 pt-[5px] flex items-center">Réfection latrines</div>
                    </figure>    
                    <figcaption>
                        <div className="pl-10 py-12 mt-3 ml-2">
                            <p className="text-base text-gray-700">
