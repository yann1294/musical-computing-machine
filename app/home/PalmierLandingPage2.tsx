        ...
        <div className=" px-6 mt-6  bg-[#EDEDCB]/70 border border-transparent ring ring-blur ring-white">
            <div className="px-1 py-1  bg-white mt-4 ml-20 mr-0 rounded-full border-[6px] w-[994px] h-[75px] border-[#B9DEC3]">
                <div className="px-4 py-0.5 rounded-full bg-[#B9DEC3] w-[100%] h-[100%]">
                    <p className="text-black">Nous soutenons des projets innovants en Afrique, visant à améliorer les conditons de vies des populations locales tout en préservant et en régénérant les écosystèmes. </p>
                </div>
            </div>
            <div className="px-1 py-1 bg-white mt-3 ml-20 mr-2 rounded-full border-[6px] w-[994px] h-[75px] border-[#B9DEC3]">
                <div className="px-4 py-0.5 rounded-full bg-[#B9DEC3] w-[100%] h-[100%]">
                    <p className="text-black">Nous créons des projets de développement innovants, façonnons l’avenir et inspirons le changement positif pour un impact durable en Afrique. </p>
                </div>
            </div>
            <div className="px-1 py-1 bg-white mt-3 ml-20 mr-2 mb-8 rounded-full border-[6px] w-[994px] h-[75px] border-[#B9DEC3]">
                <div className="px-4 py-0.5 rounded-full bg-[#B9DEC3] w-[100%] h-[100%]">
                    <p className="text-black">Nous nous engageons à promouvoir la transparence, l’efficacité et l’impact durable dans toutes nos initiatives, tout en favorisant des partenariats solides et inclusifs. </p>
                </div>
            </div>
        </div>
    </section>
